        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="https://www.facebook.com/lushbywambo" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 font-inter text-base text-white/70 hover:text-terracotta transition-colors">
                <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24">
